...
OUT = os.path.abspath(cli("--out", os.path.join(HERE, "generated", "iphone_17_low_v24.blend")))
EVIDENCE = os.path.abspath(cli("--evidence", os.path.join(HERE, "evidence", "low_v24_validation.json")))
PREVIEWS = os.path.abspath(cli("--previews", os.path.join(HERE, "previews", "low_v24")))
fc.clear_scene()
fc.setup_scene()
...
housing_x = 20.55*MM
housing_z = 52.32*MM
housing_seat = fc.rounded_prism("CAMERA_HOUSING_SEAT", 21.30*MM, 44.38*MM, 0.42*MM, 10.60*MM, back_mat, detail_c, axis="Y", location=(housing_x, back_y + GLASS_T*0.5 + 0.17*MM, housing_z), edge_bevel=0.00010, outline_segments=96)
...
housing = fc.rounded_prism("CAMERA_HOUSING", 20.54*MM, 43.62*MM, 0.94*MM, 10.27*MM, camera_housing_mat, detail_c, axis="Y", location=(housing_x, back_y + GLASS_T*0.5 + 0.50*MM, housing_z), edge_bevel=0.00018, outline_segments=96)
...
root["asset_version"] = "low_v24_0.8"
...
fc.save_blend(OUT)
renders = (
    (cam_front, "iphone_17_low_v24_front.png"),
    (cam_back, "iphone_17_low_v24_back.png"),
    (cam_three, "iphone_17_low_v24_three_quarter.png"),
    (cam_left, "iphone_17_low_v24_left_side.png"),
    (cam_right, "iphone_17_low_v24_right_side.png"),
    (cam_bottom, "iphone_17_low_v24_bottom_macro.png"),
    (cam_screen, "iphone_17_low_v24_screen_edge_macro.png"),
    (cam_camera, "iphone_17_low_v24_camera_macro.png"),
    (cam_front_sensor, "iphone_17_low_v24_front_sensor_macro.png"),
    (cam_back_three, "iphone_17_low_v24_back_three_quarter.png"),
)
