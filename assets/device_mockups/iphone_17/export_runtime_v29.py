...
RUNTIME = os.path.join(HERE, "runtime", "v29")
...
for obj in list(bpy.data.objects):
    if obj.type == "MESH" and obj.hide_render and obj.parent == root:
        bpy.data.objects.remove(obj, do_unlink=True)
runtime_logo = os.path.join(HERE, "reference", "apple_logo_alpha_runtime.png")
...
anchor("ANCHOR_REAR_CAMERA", (-0.01994, 0.003975, 0.05232))
...
glb = os.path.join(RUNTIME, "iphone_17_v29_web.glb")
...
delivery = os.path.join(RUNTIME, "iphone_17_v29_delivery.blend")
...
manifest = {
    "asset_id": "iphone_17",
    "version": "v29",
    "stage": "LOW_DRAFT_publishable_candidate",
    "source_blend": "generated/iphone_17_low_v29.blend",
    "delivery_blend": "runtime/v29/iphone_17_v29_delivery.blend",
    "glb": "runtime/v29/iphone_17_v29_web.glb",
    "body_dimensions_mm": [71.5, 149.6, 7.95],
    ...
    "lods": [{"name": "LOD0", "file": "iphone_17_v29_web.glb"}],
    "materials": materials,
    ...
    "web_variants": {
        "compat": {"file": "iphone_17_v29_web.glb", "requires": []},
    },
    "camera_fit": "runtime_bounds",
    "source_reference": "Apple iPhone 17 Dimensional Drawings 2025-09-09",
}
with open(os.path.join(RUNTIME, "iphone_17_v29.asset.json"), "w", encoding="utf-8") as f:
    json.dump(manifest, f, indent=2)
print("AWFUL_IPHONE17_V29_RUNTIME_EXPORT", json.dumps({
    "glb": glb,
    "delivery": delivery,
