...
OUT = os.path.abspath(cli("--out", os.path.join(HERE, "generated", "iphone_17_low_v22.blend")))
EVIDENCE = os.path.abspath(cli("--evidence", os.path.join(HERE, "evidence", "low_v22_validation.json")))
PREVIEWS = os.path.abspath(cli("--previews", os.path.join(HERE, "previews", "low_v22")))
fc.clear_scene()
fc.setup_scene()
...
root["asset_version"] = "low_v22_0.8"
...
evidence = {
    "asset_id": "iphone_17",
    "stage": "LOW_DRAFT",
    "revision": "physical_side_controls_v22",
...
fc.save_blend(OUT)
renders = (
    (cam_front, "iphone_17_low_v22_front.png"),
    (cam_back, "iphone_17_low_v22_back.png"),
    (cam_three, "iphone_17_low_v22_three_quarter.png"),
    (cam_left, "iphone_17_low_v22_left_side.png"),
    (cam_right, "iphone_17_low_v22_right_side.png"),
    (cam_bottom, "iphone_17_low_v22_bottom_macro.png"),
    (cam_screen, "iphone_17_low_v22_screen_edge_macro.png"),
    (cam_camera, "iphone_17_low_v22_camera_macro.png"),
    (cam_front_sensor, "iphone_17_low_v22_front_sensor_macro.png"),
    (cam_back_three, "iphone_17_low_v22_back_three_quarter.png"),
)
...
print("AWFUL_IPHONE17_V22_VALIDATION", json.dumps(evidence, sort_keys=True))
if not passed:
    raise RuntimeError("iPhone 17 LOW v22 validation failed")
