...
OUT = os.path.abspath(cli("--out", os.path.join(HERE, "generated", "iphone_17_low_v29.blend")))
EVIDENCE = os.path.abspath(cli("--evidence", os.path.join(HERE, "evidence", "low_v29_validation.json")))
PREVIEWS = os.path.abspath(cli("--previews", os.path.join(HERE, "previews", "low_v29")))
fc.clear_scene()
fc.setup_scene()
...
def camera_control(edge, z_mm, diameter_mm=2.55):
    ...
    fc.place_on_rounded_edge(control, W, H, BODY_R, edge, z_mm*MM, outward=-0.08*MM, local_normal=(0,0,1))
    return control
...
root["asset_version"] = "low_v29_1.1"
...
evidence = {
    "asset_id": "iphone_17",
    "stage": "LOW_DRAFT",
    "revision": "display_stack_repair_v29",
...
fc.save_blend(OUT)
renders = (
    (cam_front, "iphone_17_low_v29_front.png"),
    (cam_back, "iphone_17_low_v29_back.png"),
    (cam_three, "iphone_17_low_v29_three_quarter.png"),
    (cam_left, "iphone_17_low_v29_left_side.png"),
    (cam_right, "iphone_17_low_v29_right_side.png"),
    (cam_bottom, "iphone_17_low_v29_bottom_macro.png"),
    (cam_screen, "iphone_17_low_v29_screen_edge_macro.png"),
    (cam_camera, "iphone_17_low_v29_camera_macro.png"),
    (cam_front_sensor, "iphone_17_low_v29_front_sensor_macro.png"),
    (cam_back_three, "iphone_17_low_v29_back_three_quarter.png"),
)
...
print("AWFUL_IPHONE17_V29_VALIDATION", json.dumps(evidence, sort_keys=True))
if not passed:
    raise RuntimeError("iPhone 17 LOW v29 validation failed")
