...
RUNTIME = os.path.join(HERE, "runtime", "v20")
...
glb = os.path.join(RUNTIME, "iphone_17_v20_web.glb")
...
delivery = os.path.join(RUNTIME, "iphone_17_v20_delivery.blend")
...
manifest = {
    ...
    "version": "v20",
    "stage": "LOW_DRAFT",
    "source_blend": "generated/iphone_17_low_v20.blend",
    "delivery_blend": "runtime/v20/iphone_17_v20_delivery.blend",
    "glb": "runtime/v20/iphone_17_v20_web.glb",
    ...
    "lods": [{"name": "LOD0", "file": "iphone_17_v20_web.glb"}],
    "materials": materials,
    ...
    "web_variants": {
        "compat": {"file": "iphone_17_v20_web.glb", "requires": []},
    },
    "camera_fit": "runtime_bounds",
    "source_reference": "Apple iPhone 17 Dimensional Drawings 2025-09-09",
    "source_revision": SOURCE_REVISION,
    "source_commit": SOURCE_COMMIT,
    "generator_version": "web_delivery_camera_logo_normals_v20",
    "delivery_profile": {"simplification": "none", "compression": "compat+meshopt", "node_preservation": "required"},
}
with open(os.path.join(RUNTIME, "iphone_17_v20.asset.json"), "w", encoding="utf-8") as f:
    json.dump(manifest, f, indent=2)
print("AWFUL_IPHONE17_V20_RUNTIME_EXPORT", json.dumps({
    "glb": glb,
    "delivery": delivery,
