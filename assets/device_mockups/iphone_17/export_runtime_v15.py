...
RUNTIME = os.path.join(HERE, "runtime", "v15")
...
glb = os.path.join(RUNTIME, "iphone_17_v15_web.glb")
...
delivery = os.path.join(RUNTIME, "iphone_17_v15_delivery.blend")
...
manifest = {
    ...
    "source_blend": "generated/iphone_17_low_v15.blend",
    "delivery_blend": "runtime/v15/iphone_17_v15_delivery.blend",
    "glb": "runtime/v15/iphone_17_v15_web.glb",
    ...
    "lods": [{"name": "LOD0", "file": "iphone_17_v15_web.glb"}],
    "materials": materials,
    ...
    "web_variants": {
        "compat": {"file": "iphone_17_v15_web.glb", "requires": []},
    },
    "camera_fit": "runtime_bounds",
    "source_reference": "Apple iPhone 17 Dimensional Drawings 2025-09-09",
}
with open(os.path.join(RUNTIME, "iphone_17_v15.asset.json"), "w", encoding="utf-8") as f:
    json.dump(manifest, f, indent=2)
print("AWFUL_IPHONE17_V15_RUNTIME_EXPORT", json.dumps({
    "glb": glb,
    "delivery": delivery,
