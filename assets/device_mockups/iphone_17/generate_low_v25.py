...
OUT = os.path.abspath(cli("--out", os.path.join(HERE, "generated", "iphone_17_low_v25.blend")))
EVIDENCE = os.path.abspath(cli("--evidence", os.path.join(HERE, "evidence", "low_v25_validation.json")))
PREVIEWS = os.path.abspath(cli("--previews", os.path.join(HERE, "previews", "low_v25")))
fc.clear_scene()
fc.setup_scene()
...
screen_ui.location=(0,front_surface-0.003*MM,0); screen_ui.data.materials.append(screen_mat)
...
housing_x = 20.55*MM
housing_z = 52.32*MM
housing_seat = fc.rounded_prism("CAMERA_HOUSING_SEAT", 20.92*MM, 44.00*MM, 0.30*MM, 4.20*MM, back_mat, detail_c, axis="Y", location=(housing_x, back_y + GLASS_T*0.5 + 0.11*MM, housing_z), edge_bevel=0.00010, outline_segments=96)
...
housing = fc.rounded_prism("CAMERA_HOUSING", 20.54*MM, 43.62*MM, 0.72*MM, 4.00*MM, camera_housing_mat, detail_c, axis="Y", location=(housing_x, back_y + GLASS_T*0.5 + 0.36*MM, housing_z), edge_bevel=0.00018, outline_segments=96)
...
root["asset_version"] = "low_v25_0.8"
...
fc.save_blend(OUT)
renders = (
    (cam_front, "iphone_17_low_v25_front.png"),
    (cam_back, "iphone_17_low_v25_back.png"),
    (cam_three, "iphone_17_low_v25_three_quarter.png"),
    (cam_left, "iphone_17_low_v25_left_side.png"),
    (cam_right, "iphone_17_low_v25_right_side.png"),
    (cam_bottom, "iphone_17_low_v25_bottom_macro.png"),
    (cam_screen, "iphone_17_low_v25_screen_edge_macro.png"),
    (cam_camera, "iphone_17_low_v25_camera_macro.png"),
    (cam_front_sensor, "iphone_17_low_v25_front_sensor_macro.png"),
    (cam_back_three, "iphone_17_low_v25_back_three_quarter.png"),
)
