...
OUT = os.path.abspath(cli("--out", os.path.join(HERE, "generated", "iphone_17_low_v20.blend")))
EVIDENCE = os.path.abspath(cli("--evidence", os.path.join(HERE, "evidence", "low_v20_validation.json")))
PREVIEWS = os.path.abspath(cli("--previews", os.path.join(HERE, "previews", "low_v20")))
fc.clear_scene()
fc.setup_scene()
...
housing = fc.rounded_prism("CAMERA_HOUSING", 20.54*MM, 43.62*MM, 0.82*MM, 10.27*MM, metal, detail_c, axis="Y", location=(housing_x, D*0.5 + 0.47*MM, housing_z), edge_bevel=0.00015, outline_segments=96)
...
root["asset_version"] = "low_v20_0.6"
...
evidence = {
    "asset_id": "iphone_17",
    "stage": "LOW_DRAFT",
    "revision": "web_delivery_camera_logo_normals_v20",
...
fc.save_blend(OUT)
renders = (
    (cam_front, "iphone_17_low_v20_front.png"),
    (cam_back, "iphone_17_low_v20_back.png"),
    (cam_three, "iphone_17_low_v20_three_quarter.png"),
    (cam_left, "iphone_17_low_v20_left_side.png"),
    (cam_right, "iphone_17_low_v20_right_side.png"),
    (cam_bottom, "iphone_17_low_v20_bottom_macro.png"),
    (cam_screen, "iphone_17_low_v20_screen_edge_macro.png"),
    (cam_camera, "iphone_17_low_v20_camera_macro.png"),
    (cam_front_sensor, "iphone_17_low_v20_front_sensor_macro.png"),
    (cam_back_three, "iphone_17_low_v20_back_three_quarter.png"),
)
...
print("AWFUL_IPHONE17_V20_VALIDATION", json.dumps(evidence, sort_keys=True))
if not passed:
