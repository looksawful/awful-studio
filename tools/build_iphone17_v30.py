"""Rebuild the canonical iPhone 17 v30 source, web delivery and plugin bundle."""
...
def main():
    ...
    artifact_paths = {
        ...
        'compat_glb': RUNTIME / 'iphone_17_v30_web.glb',
        'meshopt_glb': RUNTIME / 'iphone_17_v30_web_meshopt.glb',
