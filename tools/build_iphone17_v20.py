"""Rebuild the canonical iPhone 17 v20 source, web delivery and plugin bundle."""
...
RUNTIME = DEVICE / 'runtime/v20'
SOURCE_FILES = [
    'assets/device_mockups/common/foundation_common.py',
    'assets/device_mockups/iphone_17/generate_low_v20.py',
...
def main():
    ...
    generated = DEVICE / 'generated/iphone_17_low_v20.blend'
    evidence = DEVICE / 'evidence/low_v20_validation.json'
    previews = DEVICE / 'previews/low_v20'
    run(blender, '--background', '--python', DEVICE / 'generate_low_v20.py', '--',
        '--out', generated, '--evidence', evidence, '--previews', previews)
    run(blender, generated, '--background', '--python', DEVICE / 'export_runtime_v20.py', '--',
        '--source-revision', revision, '--source-commit', source_commit)
    run(sys.executable, DEVICE / 'optimize_runtime_v20.py')
    bundle = ROOT / 'extension/awful_studio/assets/devices/iphone_17_low_v20.blend'
    run(blender, generated, '--background', '--python', ROOT / 'tools/package_device_asset.py', '--',
        ...
        '--key', 'IPHONE_17', '--stage', 'LOW_DRAFT', '--variant', 'low_v20', '--revision', revision)
    manifest_path = RUNTIME / 'iphone_17_v20.asset.json'
    manifest = json.loads(manifest_path.read_text(encoding='utf-8'))
    manifest['source_files'] = source_hashes
    glb_path = RUNTIME / 'iphone_17_v20_web.glb'
    ...
    artifact_paths = {
        ...
        'delivery_blend': RUNTIME / 'iphone_17_v20_delivery.blend',
        'compat_glb': RUNTIME / 'iphone_17_v20_web.glb',
        'meshopt_glb': RUNTIME / 'iphone_17_v20_web_meshopt.glb',
