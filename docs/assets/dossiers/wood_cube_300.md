    ...
    # Wood Cube 300 mm — asset dossier

    ## Identity and production role
    - Asset ID: `wood_cube_300`
    - Category: `PROP`
    ...
    - **cube_mm**: `[300, 300, 300]`; confidence `DESIGN_STANDARD`.
...
- `clear_or_matte_finish`: keep a distinct physical surface role; do not collapse unlike materials merely to reduce slots.
