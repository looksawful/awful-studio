    ...
    # Diffusion Frame 120x120 cm — asset dossier

    ## Identity and production role
    - Asset ID: `diffusion_frame_120`
    ...
    - **frame_mm**: `[1200, 1200]`; confidence `DESIGN_STANDARD`.
...
- `mount_ear`
    ...
    - `aluminum_tube`: keep a distinct physical surface role; do not collapse unlike materials merely to reduce slots.
