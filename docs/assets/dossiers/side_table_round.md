    ...
    # Side Table, Round — asset dossier

    ## Identity and production role
    - Asset ID: `side_table_round`
    - Category: `FURNITURE`
    ...
    - **design_envelope_mm**: `[500, 500, 520]`; confidence `DESIGN_STANDARD`.
...
- `feet`
    ...
    - `wood`: keep a distinct physical surface role; do not collapse unlike materials merely to reduce slots.
