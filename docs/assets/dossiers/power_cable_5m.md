    ...
    # Studio Power Cable 5 m — asset dossier

    ## Identity and production role
    - Asset ID: `power_cable_5m`
    ...
    - **length_m**: `5`; confidence `DESIGN_STANDARD`.
- **cable_diameter_mm**: `8`; confidence `DESIGN_STANDARD`.
...
- `strain_relief`
    ...
    - `rubber_jacket`: keep a distinct physical surface role; do not collapse unlike materials merely to reduce slots.
- `copper`: keep a distinct physical surface role; do not collapse unlike materials merely to reduce slots.
- `polymer`: keep a distinct physical surface role; do not collapse unlike materials merely to reduce slots.
