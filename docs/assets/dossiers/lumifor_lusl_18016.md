    ...
    # Lumifor LUSL-18016 ULTRA Shoot-through Umbrella — asset dossier

    ## Identity and production role
    - Asset ID: `lumifor_lusl_18016`
    ...
    - **diameter_mm**: `1800`; confidence `VERIFIED`.
- **rib_count**: `16`; confidence `VERIFIED`.
...
- `translucent_textile`: keep a distinct physical surface role; do not collapse unlike materials merely to reduce slots.
