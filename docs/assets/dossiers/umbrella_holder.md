    ...
    # Umbrella Holder — asset dossier

    ## Identity and production role
    - Asset ID: `umbrella_holder`
    ...
    - **receiver_mm**: `16`; confidence `DESIGN_STANDARD`.
- **umbrella_shaft_mm**: `8`; confidence `DESIGN_STANDARD`.
...
- `locking_knobs`
    ...
    - `aluminum`: keep a distinct physical surface role; do not collapse unlike materials merely to reduce slots.
- `steel`: keep a distinct physical surface role; do not collapse unlike materials merely to reduce slots.
