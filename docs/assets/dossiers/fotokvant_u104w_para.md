    ...
    # Fotokvant U-104W Para White Umbrella — asset dossier

    ## Identity and production role
    - Asset ID: `fotokvant_u104w_para`
    ...
    - **diameter_mm**: `1040`; confidence `VERIFIED`.
- **mass_kg**: `0.4`; confidence `VERIFIED`.
...
- `tips`
    ...
    - `metal_shaft`: keep a distinct physical surface role; do not collapse unlike materials merely to reduce slots.
- `fiberglass`: keep a distinct physical surface role; do not collapse unlike materials merely to reduce slots.
- `white_textile`: keep a distinct physical surface role; do not collapse unlike materials merely to reduce slots.
- `black_trim`: keep a distinct physical surface role; do not collapse unlike materials merely to reduce slots.
