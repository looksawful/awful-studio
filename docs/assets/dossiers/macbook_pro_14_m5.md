    ...
    # MacBook Pro 14 M5 — asset dossier

    ## Identity and production role
    - Asset ID: `macbook_pro_14_m5`
    ...
    - **closed_mm**: `[312.6, 221.2, 15.5]`; confidence `VERIFIED`.
- **lid_mm**: `[312, 212, 4.7]`; confidence `PROJECT_VERIFIED`.
...
- `keycap_polymer`: keep a distinct physical surface role; do not collapse unlike materials merely to reduce slots.
- `trackpad_glass`: keep a distinct physical surface role; do not collapse unlike materials merely to reduce slots.
...
- `decal`: keep a distinct physical surface role; do not collapse unlike materials merely to reduce slots.
    ...
    **Articulation**
    - lid_hinge: reviewed preset 102deg
...
## Production handoff
- Next gate: `RELEASE_CANDIDATE` → blockout/review unless the current stage is already further advanced.
