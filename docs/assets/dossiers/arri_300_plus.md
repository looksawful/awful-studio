    ...
    - **with_pin_mm**: `[187, 160, 254]`; confidence `VERIFIED`.
- **body_mm**: `[187, 160, 209]`; confidence `VERIFIED`.
- **lens_diameter_mm**: `80`; confidence `VERIFIED`.
- **mass_kg**: `2`; confidence `VERIFIED`.
...
- `cable`
    ...
    - `painted_aluminum`: keep a distinct physical surface role; do not collapse unlike materials merely to reduce slots.
- `optical_glass`: keep a distinct physical surface role; do not collapse unlike materials merely to reduce slots.
- `stainless_fasteners`: keep a distinct physical surface role; do not collapse unlike materials merely to reduce slots.
- `heat_resistant_polymer`: keep a distinct physical surface role; do not collapse unlike materials merely to reduce slots.
- `rubber_cable`: keep a distinct physical surface role; do not collapse unlike materials merely to reduce slots.
