    ...
    # Air-cushioned Light Stand — asset dossier

    ## Identity and production role
    - Asset ID: `air_cushioned_light_stand`
    ...
    - **height_range_mm**: `[1000, 3000]`; confidence `DESIGN_STANDARD`.
- **footprint_mm**: `1000`; confidence `DESIGN_STANDARD`.
