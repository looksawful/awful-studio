    ...
    # Black Flag 60x90 cm — asset dossier

    ## Identity and production role
    - Asset ID: `black_flag_60x90`
    ...
    - **frame_mm**: `[600, 900]`; confidence `DESIGN_STANDARD`.
...
- `mount_ear`
    ...
    - `steel_rod`: keep a distinct physical surface role; do not collapse unlike materials merely to reduce slots.
