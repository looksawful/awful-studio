    ...
    # Lounge Armchair, Leather — asset dossier

    ## Identity and production role
    - Asset ID: `lounge_armchair_leather`
    - Category: `FURNITURE`
...
- `feet`
    ...
    - `leather`: keep a distinct physical surface role; do not collapse unlike materials merely to reduce slots.
