    ...
    # Boom Counterweight 4 kg — asset dossier

    ## Identity and production role
    - Asset ID: `counterweight_4kg`
    ...
    - **mass_kg**: `4`; confidence `DESIGN_STANDARD`.
- **envelope_mm**: `[180, 100, 100]`; confidence `DESIGN_STANDARD`.
...
- `locking_knob`
    ...
    - `painted_steel`: keep a distinct physical surface role; do not collapse unlike materials merely to reduce slots.
