    ...
    # Studio Sandbag 10 kg — asset dossier

    ## Identity and production role
    - Asset ID: `sandbag_10kg`
    - Category: `LIGHT_ACCESSORY`
    ...
    - **envelope_mm**: `[360, 250, 70]`; confidence `PROJECT_VERIFIED`.
- **nominal_mass_kg**: `10`; confidence `DESIGN_STANDARD`.
...
- `label_patch`
    ...
    ## Geometry plan
    Model only geometry that affects mounting, silhouette, collision or close-up readability; repeat hardware by instances.
    ...
    - `ballistic_nylon`: keep a distinct physical surface role; do not collapse unlike materials merely to reduce slots.
- `webbing`: keep a distinct physical surface role; do not collapse unlike materials merely to reduce slots.
- `thread`: keep a distinct physical surface role; do not collapse unlike materials merely to reduce slots.
- `granular_fill`: keep a distinct physical surface role; do not collapse unlike materials merely to reduce slots.
