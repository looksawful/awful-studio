    ...
    # White Reflector Card 100x150 cm — asset dossier

    ## Identity and production role
    - Asset ID: `white_reflector_100x150`
    ...
    - **panel_mm**: `[1000, 1500, 20]`; confidence `DESIGN_STANDARD`.
...
- `mount_points`
    ...
    - `foam_board`: keep a distinct physical surface role; do not collapse unlike materials merely to reduce slots.
- `matte_white_surface`: keep a distinct physical surface role; do not collapse unlike materials merely to reduce slots.
- `fabric_tape`: keep a distinct physical surface role; do not collapse unlike materials merely to reduce slots.
