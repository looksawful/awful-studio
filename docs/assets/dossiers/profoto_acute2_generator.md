    ...
    - **1200_mm**: `[220, 190, 130]`; confidence `VERIFIED`.
- **2400_mm**: `[300, 190, 130]`; confidence `VERIFIED`.
- **mass_kg**: `{"1200": 4.1, "2400": 5.9}`; confidence `VERIFIED`.
...
- `labels`
    ...
    - `painted_sheet_metal`: keep a distinct physical surface role; do not collapse unlike materials merely to reduce slots.
...
- `screen_print_decals`: keep a distinct physical surface role; do not collapse unlike materials merely to reduce slots.
