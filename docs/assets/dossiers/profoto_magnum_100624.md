    ...
    # Profoto Magnum Reflector 100624 — asset dossier

    ## Identity and production role
    - Asset ID: `profoto_magnum_100624`
    ...
    - **diameter_mm**: `345`; confidence `VERIFIED`.
- **depth_mm**: `265`; confidence `VERIFIED`.
- **mass_kg**: `0.8`; confidence `VERIFIED`.
...
- `label_zone`
    ...
    - `matte_black_coating`: keep a distinct physical surface role; do not collapse unlike materials merely to reduce slots.
- `high_reflectance_silver`: keep a distinct physical surface role; do not collapse unlike materials merely to reduce slots.
- `aluminum_rim`: keep a distinct physical surface role; do not collapse unlike materials merely to reduce slots.
- `printed_label`: keep a distinct physical surface role; do not collapse unlike materials merely to reduce slots.
