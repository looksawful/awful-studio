    ...
    # Dining Chair, Wood — asset dossier

    ## Identity and production role
    - Asset ID: `dining_chair_wood`
    - Category: `FURNITURE`
    ...
    - **design_envelope_mm**: `[480, 520, 820]`; confidence `DESIGN_STANDARD`.
...
- `clear_finish`: keep a distinct physical surface role; do not collapse unlike materials merely to reduce slots.
