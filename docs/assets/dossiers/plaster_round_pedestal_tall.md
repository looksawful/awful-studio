    ...
    # Round Pedestal, Tall — asset dossier

    ## Identity and production role
    - Asset ID: `plaster_round_pedestal_tall`
    - Category: `PROP`
    ...
    - **diameter_mm**: `450`; confidence `DESIGN_STANDARD`.
- **height_mm**: `900`; confidence `DESIGN_STANDARD`.
