    ...
    # Profoto RFi Softbox 5 ft Octa 254712 — asset dossier

    ## Identity and production role
    - Asset ID: `profoto_rfi_octa_150_254712`
    ...
    - **front_diameter_mm**: `1500`; confidence `VERIFIED`.
- **depth_mm**: `470`; confidence `VERIFIED`.
- **rod_count**: `8`; confidence `VERIFIED`.
...
- `silver_lining`
    ...
    - `black_textile`: keep a distinct physical surface role; do not collapse unlike materials merely to reduce slots.
- `silver_textile`: keep a distinct physical surface role; do not collapse unlike materials merely to reduce slots.
- `diffusion_textile`: keep a distinct physical surface role; do not collapse unlike materials merely to reduce slots.
- `spring_steel`: keep a distinct physical surface role; do not collapse unlike materials merely to reduce slots.
