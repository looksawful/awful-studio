    ...
    # Chair, Wood + Metal — asset dossier

    ## Identity and production role
    - Asset ID: `chair_wood_metal`
    - Category: `FURNITURE`
    ...
    - **design_envelope_mm**: `[500, 540, 820]`; confidence `DESIGN_STANDARD`.
...
- `feet`
    ...
    - `hardwood`: keep a distinct physical surface role; do not collapse unlike materials merely to reduce slots.
