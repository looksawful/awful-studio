    ...
    # Profoto Softlight Reflector White 100608 — asset dossier

    ## Identity and production role
    - Asset ID: `profoto_softlight_white_100608`
...
- **depth_mm**: `190`; confidence `VERIFIED`.
...
- `matte_white_inner`: keep a distinct physical surface role; do not collapse unlike materials merely to reduce slots.
