    ...
    # Studio Table, Rectangular — asset dossier

    ## Identity and production role
    - Asset ID: `studio_table_rect`
    - Category: `FURNITURE`
    ...
    - **design_envelope_mm**: `[1600, 800, 750]`; confidence `DESIGN_STANDARD`.
...
- `feet`
    ...
    - `wood_veneer`: keep a distinct physical surface role; do not collapse unlike materials merely to reduce slots.
- `plywood`: keep a distinct physical surface role; do not collapse unlike materials merely to reduce slots.
- `powder_coated_steel`: keep a distinct physical surface role; do not collapse unlike materials merely to reduce slots.
