    ...
    # 16 mm Baby Pin — asset dossier

    ## Identity and production role
    - Asset ID: `baby_pin_16mm`
    ...
    - **diameter_mm**: `16`; confidence `DESIGN_STANDARD`.
- **length_mm**: `100`; confidence `DESIGN_STANDARD`.
...
- `zinc_plated_steel`: keep a distinct physical surface role; do not collapse unlike materials merely to reduce slots.
