    ...
    # Avenger D200 Grip Head Reference — asset dossier

    ## Identity and production role
    - Asset ID: `avenger_d200_grip_head`
    ...
    - **disc_diameter_mm**: `63.5`; confidence `VERIFIED`.
- **receiver_mm**: `16`; confidence `VERIFIED`.
