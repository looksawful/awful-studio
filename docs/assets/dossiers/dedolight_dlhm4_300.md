    ...
    # Dedolight DLHM4-300 — asset dossier

    ## Identity and production role
    - Asset ID: `dedolight_dlhm4_300`
    ...
    - **envelope_mm**: `[171, 132, 174]`; confidence `SECONDARY_VERIFIED`.
- **mass_kg**: `1.02`; confidence `VERIFIED`.
- **power_w**: `150`; confidence `VERIFIED`.
...
- `16mm_mount`
    ...
    - `black_cast_metal`: keep a distinct physical surface role; do not collapse unlike materials merely to reduce slots.
- `anodized_metal`: keep a distinct physical surface role; do not collapse unlike materials merely to reduce slots.
