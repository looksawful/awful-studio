    ...
    # Grifon SB-FW95 Octabox — asset dossier

    ## Identity and production role
    - Asset ID: `grifon_sb_fw95`
    ...
    - **front_diameter_mm**: `950`; confidence `VERIFIED`.
...
- `speedring_interface`
    ...
    - `black_nylon`: keep a distinct physical surface role; do not collapse unlike materials merely to reduce slots.
- `silver_reflective_textile`: keep a distinct physical surface role; do not collapse unlike materials merely to reduce slots.
- `diffusion_textile`: keep a distinct physical surface role; do not collapse unlike materials merely to reduce slots.
- `spring_steel_rods`: keep a distinct physical surface role; do not collapse unlike materials merely to reduce slots.
